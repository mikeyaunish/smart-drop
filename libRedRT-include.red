...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_ctx||315~decode-unicode-char: "f_ctx||315~decode-unicode-char" [octx [pointer! [integer!]]] 
            f_ctx||315~push: "f_ctx||315~push" [octx [pointer! [integer!]]] 
            f_ctx||315~pop: "f_ctx||315~pop" [octx [pointer! [integer!]]] 
            f_ctx||315~emit: "f_ctx||315~emit" [octx [pointer! [integer!]]] 
            f_load-json: "f_load-json" [octx [pointer! [integer!]]] 
            f_ctx||322~init-state: "f_ctx||322~init-state" [octx [pointer! [integer!]]] 
            f_ctx||322~emit-indent: "f_ctx||322~emit-indent" [octx [pointer! [integer!]]] 
            f_ctx||322~emit-key-value: "f_ctx||322~emit-key-value" [octx [pointer! [integer!]]] 
            f_ctx||322~red-to-json-value: "f_ctx||322~red-to-json-value" [octx [pointer! [integer!]]] 
            f_to-json: "f_to-json" [octx [pointer! [integer!]]] 
            f_ctx||329~encode: "f_ctx||329~encode" [octx [pointer! [integer!]]] 
            f_ctx||329~decode: "f_ctx||329~decode" [octx [pointer! [integer!]]] 
            f_ctx||336~encode: "f_ctx||336~encode" [octx [pointer! [integer!]]] 
            f_ctx||336~decode: "f_ctx||336~decode" [octx [pointer! [integer!]]] 
            f_ctx||341~to-csv-line: "f_ctx||341~to-csv-line" [octx [pointer! [integer!]]] 
            f_ctx||341~escape-value: "f_ctx||341~escape-value" [octx [pointer! [integer!]]] 
            f_ctx||341~next-column-name: "f_ctx||341~next-column-name" [octx [pointer! [integer!]]] 
            f_ctx||341~make-header: "f_ctx||341~make-header" [octx [pointer! [integer!]]] 
            f_ctx||341~get-columns: "f_ctx||341~get-columns" [octx [pointer! [integer!]]] 
            f_ctx||341~encode-map: "f_ctx||341~encode-map" [octx [pointer! [integer!]]] 
            f_ctx||341~encode-maps: "f_ctx||341~encode-maps" [octx [pointer! [integer!]]] 
            f_ctx||341~encode-flat: "f_ctx||341~encode-flat" [octx [pointer! [integer!]]] 
            f_ctx||341~encode-blocks: "f_ctx||341~encode-blocks" [octx [pointer! [integer!]]] 
            f_load-csv: "f_load-csv" [octx [pointer! [integer!]]] 
            f_to-csv: "f_to-csv" [octx [pointer! [integer!]]] 
            f_ctx||357~on-change*: "f_ctx||357~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||360~on-change*: "f_ctx||360~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||360~on-deep-change*: "f_ctx||360~on-deep-change*" [octx [pointer! [integer!]]] 
            f_reactor: "f_reactor" [] 
            f_deep-reactor: "f_deep-reactor" [] 
            f_ctx||365~add-relation: "f_ctx||365~add-relation" [octx [pointer! [integer!]]] 
            f_ctx||365~eval: "f_ctx||365~eval" [octx [pointer! [integer!]]] 
            f_ctx||365~eval-reaction: "f_ctx||365~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx||365~pending?: "f_ctx||365~pending?" [octx [pointer! [integer!]]] 
            f_ctx||365~check: "f_ctx||365~check" [octx [pointer! [integer!]]] 
            ...
            f_ctx||365~is~: "f_ctx||365~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_register-scheme: "f_register-scheme" [] 
            f_ctx||379~alpha-num+: "f_ctx||379~alpha-num+" [octx [pointer! [integer!]]] 
            f_ctx||379~parse-url: "f_ctx||379~parse-url" [octx [pointer! [integer!]]] 
            f_decode-url: "f_decode-url" [octx [pointer! [integer!]]] 
            f_encode-url: "f_encode-url" [octx [pointer! [integer!]]] 
            f_ctx||385~do-quit: "f_ctx||385~do-quit" [octx [pointer! [integer!]]] 
            f_ctx||385~throw-error: "f_ctx||385~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||385~syntax-error: "f_ctx||385~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx||385~do-safe: "f_ctx||385~do-safe" [octx [pointer! [integer!]]] 
            f_ctx||385~do-code: "f_ctx||385~do-code" [octx [pointer! [integer!]]] 
            f_ctx||385~count-args: "f_ctx||385~count-args" [octx [pointer! [integer!]]] 
            f_ctx||385~arg-mode?: "f_ctx||385~arg-mode?" [octx [pointer! [integer!]]] 
            f_ctx||385~func-arity?: "f_ctx||385~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx||385~value-path?: "f_ctx||385~value-path?" [octx [pointer! [integer!]]] 
            f_ctx||385~fetch-next: "f_ctx||385~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx||385~eval: "f_ctx||385~eval" [octx [pointer! [integer!]]] 
            f_ctx||385~do-macro: "f_ctx||385~do-macro" [octx [pointer! [integer!]]] 
            f_ctx||385~register-macro: "f_ctx||385~register-macro" [octx [pointer! [integer!]]] 
            f_ctx||385~reset: "f_ctx||385~reset" [octx [pointer! [integer!]]] 
            f_ctx||385~expand: "f_ctx||385~expand" [octx [pointer! [integer!]]] 
            f_expand-directives: "f_expand-directives" [octx [pointer! [integer!]]] 
            f_ctx||403~calc-max: "f_ctx||403~calc-max" [octx [pointer! [integer!]]] 
            f_ctx||403~show-context: "f_ctx||403~show-context" [octx [pointer! [integer!]]] 
            f_ctx||403~show-parents: "f_ctx||403~show-parents" [octx [pointer! [integer!]]] 
            f_ctx||403~show-stack: "f_ctx||403~show-stack" [octx [pointer! [integer!]]] 
            f_ctx||403~show-watching: "f_ctx||403~show-watching" [octx [pointer! [integer!]]] 
            f_ctx||403~do-command: "f_ctx||403~do-command" [octx [pointer! [integer!]]] 
            f_ctx||403~debugger: "f_ctx||403~debugger" [octx [pointer! [integer!]]] 
            f_ctx||420~dumper: "f_ctx||420~dumper" [octx [pointer! [integer!]]] 
            f_ctx||420~push: "f_ctx||420~push" [octx [pointer! [integer!]]] 
            f_ctx||420~drop: "f_ctx||420~drop" [octx [pointer! [integer!]]] 
            f_ctx||420~pop: "f_ctx||420~pop" [octx [pointer! [integer!]]] 
            f_ctx||420~top: "f_ctx||420~top" [octx [pointer! [integer!]]] 
            f_ctx||420~incr: "f_ctx||420~incr" [octx [pointer! [integer!]]] 
            f_ctx||428~reset: "f_ctx||428~reset" [octx [pointer! [integer!]]] 
            f_ctx||428~collector: "f_ctx||428~collector" [octx [pointer! [integer!]]] 
            f_ctx||420~guided-trace: "f_ctx||420~guided-trace" [octx [pointer! [integer!]]] 
            f_ctx||433~mold-part: "f_ctx||433~mold-part" [octx [pointer! [integer!]]] 
            f_ctx||433~inspect: "f_ctx||433~inspect" [octx [pointer! [integer!]]] 
            f_ctx||403~profiler: "f_ctx||403~profiler" [octx [pointer! [integer!]]] 
            f_ctx||403~do-handler: "f_ctx||403~do-handler" [octx [pointer! [integer!]]] 
            ...
            f_ctx||453~tail-idx?: "f_ctx||453~tail-idx?" [octx [pointer! [integer!]]] 
            f_ctx||453~push-color: "f_ctx||453~push-color" [octx [pointer! [integer!]]] 
            f_ctx||453~pop-color: "f_ctx||453~pop-color" [octx [pointer! [integer!]]] 
            f_ctx||453~close-colors: "f_ctx||453~close-colors" [octx [pointer! [integer!]]] 
            f_ctx||453~push: "f_ctx||453~push" [octx [pointer! [integer!]]] 
            f_ctx||453~pop: "f_ctx||453~pop" [octx [pointer! [integer!]]] 
            f_ctx||453~pop-all: "f_ctx||453~pop-all" [octx [pointer! [integer!]]] 
            f_ctx||453~optimize: "f_ctx||453~optimize" [octx [pointer! [integer!]]] 
            f_rtd-layout: "f_rtd-layout" [octx [pointer! [integer!]]] 
            f_ctx||451~line-height?: "f_ctx||451~line-height?" [octx [pointer! [integer!]]] 
            f_ctx||451~line-count?: "f_ctx||451~line-count?" [octx [pointer! [integer!]]] 
            f_metrics?: "f_metrics?" [] 
            ...
            f_ctx||473~on-change*: "f_ctx||473~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||473~on-deep-change*: "f_ctx||473~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||477~on-change*: "f_ctx||477~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||477~on-deep-change*: "f_ctx||477~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx||481~on-change*: "f_ctx||481~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||484~on-change*: "f_ctx||484~on-change*" [octx [pointer! [integer!]]] 
            f_ctx||487~capture-events: "f_ctx||487~capture-events" [octx [pointer! [integer!]]] 
            f_ctx||487~awake: "f_ctx||487~awake" [octx [pointer! [integer!]]] 
            f_ctx||495~init: "f_ctx||495~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx||503~color-backgrounds: "f_ctx||503~color-backgrounds" [octx [pointer! [integer!]]] 
            f_ctx||503~color-tabpanel-children: "f_ctx||503~color-tabpanel-children" [octx [pointer! [integer!]]] 
            f_ctx||503~OK-Cancel: "f_ctx||503~OK-Cancel" [octx [pointer! [integer!]]] 
            f_ctx||501~process: "f_ctx||501~process" [octx [pointer! [integer!]]] 
            f_ctx||499~throw-error: "f_ctx||499~throw-error" [octx [pointer! [integer!]]] 
            f_ctx||499~process-reactors: "f_ctx||499~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx||499~calc-size: "f_ctx||499~calc-size" [octx [pointer! [integer!]]] 
            f_ctx||499~align-faces: "f_ctx||499~align-faces" [octx [pointer! [integer!]]] 
            f_ctx||499~resize-child-panels: "f_ctx||499~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx||499~clean-style: "f_ctx||499~clean-style" [octx [pointer! [integer!]]] 
            f_ctx||499~process-draw: "f_ctx||499~process-draw" [octx [pointer! [integer!]]] 
            f_ctx||499~pre-load: "f_ctx||499~pre-load" [octx [pointer! [integer!]]] 
            f_ctx||499~add-option: "f_ctx||499~add-option" [octx [pointer! [integer!]]] 
            f_ctx||499~add-flag: "f_ctx||499~add-flag" [octx [pointer! [integer!]]] 
            f_ctx||499~fetch-value: "f_ctx||499~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx||499~fetch-argument: "f_ctx||499~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx||499~fetch-expr: "f_ctx||499~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx||499~fetch-options: "f_ctx||499~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx||499~make-actor: "f_ctx||499~make-actor" [octx [pointer! [integer!]]] 
            ...
            ctx||315~unescape: "ctx||315~unescape" [str [red-string!] return: [red-string!]] 
            ctx||354~encode: "ctx||354~encode" [data [cell!] where [cell!]] 
            ctx||354~decode: "ctx||354~decode" [payload [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx||495~make-null-handle: "ctx||495~make-null-handle" [] 
            ctx||495~get-screen-size: "ctx||495~get-screen-size" [id [integer!]] 
            ctx||495~size-text: "ctx||495~size-text" [face [red-object!] value [cell!]] 
            ctx||495~on-change-facet: "ctx||495~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx||495~update-font: "ctx||495~update-font" [font [red-object!] flags [integer!]] 
            ctx||495~update-para: "ctx||495~update-para" [face [red-object!] flags [integer!]] 
            ctx||495~destroy-view: "ctx||495~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx||495~update-view: "ctx||495~update-view" [face [red-object!]] 
            ctx||495~refresh-window: "ctx||495~refresh-window" [h [red-handle!]] 
            ctx||495~redraw: "ctx||495~redraw" [face [red-object!]] 
            ctx||495~show-window: "ctx||495~show-window" [id [red-handle!]] 
            ctx||495~make-view: "ctx||495~make-view" [face [red-object!] parent [red-handle!]] 
            ctx||495~draw-image: "ctx||495~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx||495~draw-face: "ctx||495~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx||495~do-event-loop: "ctx||495~do-event-loop" [no-wait? [logic!]] 
            ctx||495~exit-event-loop: "ctx||495~exit-event-loop" [] 
            ctx||495~request-font: "ctx||495~request-font" [font [red-object!] selected [cell!] mono? [logic!]] 
            ctx||495~request-file: "ctx||495~request-file" [title [cell!] name [cell!] filter [cell!] save? [logic!] multi? [logic!]] 
            ctx||495~request-dir: "ctx||495~request-dir" [title [cell!] dir [cell!] filter [cell!] keep? [logic!] multi? [logic!]] 
            ctx||495~text-box-metrics: "ctx||495~text-box-metrics" [box [red-object!] arg0 [cell!] type [integer!]] 
            ctx||495~update-scroller: "ctx||495~update-scroller" [scroller [red-object!] flags [integer!]] 
